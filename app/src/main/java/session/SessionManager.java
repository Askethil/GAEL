...
import com.example.utilisateur.gael.MainActivity;
...
public class SessionManager {
    ...
    // Mdp address (make variable public to access from outside)
     ...
     * */
    public void createLoginSession(String login, String mdp, String id){
